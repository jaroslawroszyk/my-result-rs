...
mod tests {
    ...
    fn test_from_ok_creates_ok_variant() {
        ...
        let result: MyResult<String, &str> =
            <MyResult<String, &str> as MyTry>::from_ok(val.clone());
    ...
    fn test_edge_cases() {
        ...
        let result: MyResult<Option<i32>, &str> =
            <MyResult<Option<i32>, &str> as MyTry>::from_ok(opt);
